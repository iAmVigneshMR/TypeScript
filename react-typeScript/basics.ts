// Primitives: number, string, boolean (primitive types are lower case)
...
type Person = {  //'type' is TypeScript keyword which allow us to avoid duplication(using same again and again)
  name: string;
  age: number;
};
...
// Type inference
//union allow one or more datatypes
